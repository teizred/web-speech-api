...
export const ExportButtons = ({ onReset, onHistorySelect }: ExportButtonsProps) => {
  ...
  return (
    <div className="bg-white rounded-3xl p-4 md:p-6 shadow-sm border border-slate-100 space-y-3 md:space-y-4">
      ...
      <button
        ...
        className="w-full bg-amber-500 hover:bg-amber-600 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-200 flex items-center justify-center gap-2"
      >
